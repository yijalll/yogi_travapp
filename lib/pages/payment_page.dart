      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            title: const Text('BRI A/N Ratna Sari Dewi'),
          ...
          ListTile(
            tileColor: AppColors.white,
            leading: Assets.icPayment.image(),
            title: const Text('BCA A/N Ratna Sari Dewi'),
          ...
          ListTile(
            tileColor: AppColors.white,
            leading: Assets.icPayment.image(),
            title: const Text('BSI A/N Ratna Sari Dewi'),
          ...
          ListTile(
            tileColor: AppColors.white,
            leading: Assets.icPayment.image(),
            title: const Text('DANA A/N Ratna Sari Dewi'), 
